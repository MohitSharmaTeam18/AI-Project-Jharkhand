...
This folder collects external links referenced by the project that are not
stored directly in the repository (large or live-editable files).

## Source Inventory

**Jharkhand Source Inventory (Phase 1)**
...
kept as the live working copy in case entries are corrected or added after
